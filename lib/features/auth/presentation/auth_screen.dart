            ...
            child: Padding(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    Text(_isLogin ? 'Вход' : 'Регистрация', style: theme.textTheme.headlineMedium),
                    const SizedBox(height: 12),
                    if (!_isLogin) ...[
                      TextFormField(
                        controller: _name,
                        decoration: const InputDecoration(labelText: 'Имя'),
                        validator: (v) => (v == null || v.trim().length < 2) ? 'Минимум 2 символа' : null,
                      ),
                    ...
                    TextFormField(
                      ...
                      validator: (v) => (v == null || v.trim().length < 6) ? 'Минимум 6 символов' : null,
                    ),
                    if (!_isLogin) ...[
                      const SizedBox(height: 10),
                    ...
                    SizedBox(
                      ...
                      child: FilledButton(
                        ...
                        child: Text(_loading ? 'Загрузка...' : (_isLogin ? 'Войти' : 'Создать аккаунт')),
                      ),
                    ),
